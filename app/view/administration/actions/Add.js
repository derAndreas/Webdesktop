...
/**
 * @class Webdesktop.view.administration.actions.Add
 * @extends Ext.form.Panel
 * @alias administration_actionadd
 ...
 */
Ext.define('Webdesktop.view.administration.actions.Add', {
    extend : 'Ext.form.Panel',
    alias  : 'widget.administration_actionadd',
    /**
     * Configure the formpanel
     */
    initComponent:function() {
        ...
        Ext.apply(me, {
            ...
            items: [{
                ...
                allowBlank : false,     //FIXME: remove, after validations in Action Model are final
                readOnly   : false
            }],
            dockedItems: [{
                xtype : 'toolbar',
