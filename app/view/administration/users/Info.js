...
/**
 * @class Webdesktop.view.administration.users.Info
 * @extends Ext.panel.Panel
 * @alias administration_userinfo
 ...
 * @todo Currently this is only a placeholder, needs some content
 */
Ext.define('Webdesktop.view.administration.users.Info', {
    extend : 'Ext.panel.Panel',
    alias  : 'widget.administration_userinfo',
